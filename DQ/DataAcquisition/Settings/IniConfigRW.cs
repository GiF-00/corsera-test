...
{
	/// <summary>
	/// Class <c>IniConfigRW</c> helps in reading and writing <c>.ini</c> files.
	/// </summary>
	public class IniConfigRW
	{
		...
		public IniConfigRW(string filename, ILogger? logger = null)
		{
			Filename = filename;
			_config = new();
			_logger = logger;
		...
		private void LoadFile()
		{
			...
			_logger?.Info($"Reading configuration file: \"{Filename}\"");
			...
			_logger?.Info($"Completed reading configuration file: \"{Filename}\"");
		}
		...
		public void Clear()
		{
			_logger?.Info($"Clearing current configuration that was loaded from file: \"{Filename}\"");
			_config.Clear();
		}
		/// <summary>
		...
		{
			_logger?.Info($"Writing current configuration to file: \"{Filename}\"");
			...
			_logger?.Info($"Completed writing configuration to file: \"{Filename}\"");
		}
